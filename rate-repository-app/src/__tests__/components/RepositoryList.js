...
import RepositoryListContainer from '../../components/RepositoryList'; // adjust path
...
describe('RepositoryList', () => {
  describe('RepositoryListContainer', () => {
    it('renders repository information correctly', () => {
      ...
      expect(repositoryItems[0]).toHaveTextContent('1.6k'); // forks formatted
      expect(repositoryItems[0]).toHaveTextContent('21.9k'); // stars formatted
      ...
      expect(repositoryItems[1]).toHaveTextContent('1.8k'); // stars formatted
